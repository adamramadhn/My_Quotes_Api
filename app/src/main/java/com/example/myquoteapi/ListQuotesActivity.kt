package com.example.myquoteapi
...
import com.example.myquoteapi.databinding.ActivityListQuotesBinding
    ...
    private fun getListQuotes() {
        ...
        client.get(url, object : AsyncHttpResponseHandler() {
            override fun onSuccess(statusCode: Int, headers: Array<Header>, responseBody: ByteArray) {
                ...
                Log.d(TAG, result)
                try {
                    //karena [ ] merupakan Array, maka parsing dengan berikut,
                    val jsonArray = JSONArray(result)
                    //mengambil Object dalam Array tsb dengan cara berikut,
